...
<div class="container">
			...
			<br />
			<br />
			<h2>Buscar Cliente por nombre o apellido </h2><br />
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">Buscar</span>
					<input type="text" name="search_text" id="search_text" placeholder="Nombre o Apellido" class="form-control" />
				</div>
			</div>
			<br />
			<div id="result"></div>
