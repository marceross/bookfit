<?
	...
	{
		if(mysqli_query($mysqli,"INSERT INTO caja_cierre (billetes, monedas, fecha, hora, id_usuario) VALUES ('$billetes','$monedas','$fecha','$hora4','$id_usuario')"))
		{
			//Cierro caja
			mysqli_query($mysqli,"UPDATE caja SET cerrada='S' WHERE cerrada='N'");
			$error=0;
