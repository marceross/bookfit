<?
	...
	{		
		...
		$mensajes_conversaciones=mysqli_query($mysqli, "SELECT * FROM mensajes WHERE id_conversacion='$id_conversacion' AND id_usuario_rem<>'$id_usuario'");
		$mensaje_conversacion=mysqli_fetch_array($mensajes_conversaciones);
		$id_dest=$mensaje_conversacion['id_usuario_rem'];
	}
	...
	header("Location:app_mensajes_profe.php");
?>