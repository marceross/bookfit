<?
	...
	//$ultima_fecha=mysqli_query($mysqli,"SELECT MAX(Fecha) FROM ventas");
...
<div class="container">
	<h6>Total ventas de hoy ($ <? echo $total_ventas;?>)</h6>
    <!--<h5>Detalle por ventas y clientes</h5>-->
	<!--<button type="button" class="btn btn-info btn-sm" onClick="crear_tabla('ventas')">Ventas</button>-->
