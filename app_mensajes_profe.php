...
function abrir_mensajes(conversacion)
{
  if($('#ocultos_'+conversacion).css('display')=='none')
  {
    ...
    $(conversacion).addClass('badge-success');
  }
  else
  {
    $('#ocultos_'+conversacion).css('display', 'none');
    $(conversacion).addClass('badge-warning');
  }
}
 ...
 // {
   // $fecha_movimiento=$mensaje_fecha['fecha'];
    ...
    {   
      ...
      //Buscamos el nombre del remitente en registrados, sin no lo encuentra busca en usuarios
...
// si el id_mensaje es el último de la conversación mostrar campo
      ...
      {
         ?>
         <form action="app_mensaje_procesa2.php?id_conversacion=<? echo $id_conversacion;?>" method="post" enctype="multipart/form-data" name="">
         <div class="form-row row justify-content-center">
           <div class="form-group col-md-4">
        ...
        <div class="row justify-content-start">
          ...
          <div class="col-5">
            ...
            <? 
              ...
              {
                $flecha='<a href="#" onClick="abrir_mensajes('.$msj['id_conversacion'].')">></a>';
              ...
              ?>
                ...
                <span class="badge badge-success"><? echo $flecha;?></span>
              <? 
