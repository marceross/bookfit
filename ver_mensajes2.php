...
$mensajes=mysql_query("SELECT * FROM mensajes_internos, mensajes_internos_destinatarios, usuarios WHERE usuarios.id_usuario=mensajes_internos.id_usuario_rem AND mensajes_internos.id_mensaje=mensajes_internos_destinatarios.id_mensaje",$link);
$usuarios=mysql_query("SELECT * FROM usuarios WHERE activo='S' AND id_tipo_usuario='2'",$link);
?>
<html>
<head>
